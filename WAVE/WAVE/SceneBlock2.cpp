...
void CSceneBlock2::InitScene()
{
	...
	int size;//ステージ情報の大きさ
	p = Save::ExternalDataOpen(L"Stage/stage2222.csv", &size);//外部データ読み込み
	...
	//音楽読み込み
	Audio::LoadAudio(22, L"BackM/back2.wav",BACK_MUSIC);
	...
	//Blockのグラフィック読み込み
	Draw::LoadImageW(L"Block/blocka2.png", 10, TEX_SIZE_512);
	...
	//氷柱のグラフィック読み込み
	Draw::LoadImageW(L"Block/icicle2.png", 33, TEX_SIZE_512);

	//土中のグラフィック読み込み
	Draw::LoadImageW(L"Block/snow1.png", 30, TEX_SIZE_512);
	
	//道中２のグラフィック読み込み
	Draw::LoadImageW(L"Block/bblock1.png", 31, TEX_SIZE_512);
	...
	//ドラゴン攻撃エフェクト画像
	Draw::LoadImageW(L"Eff/image1234.png", 28, TEX_SIZE_512);
	...
	//ギミック氷柱用画像
	Draw::LoadImageW(L"Block/turara.png", 37, TEX_SIZE_256);//氷柱用ギミック画像
