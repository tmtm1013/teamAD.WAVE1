...
void CSceneMain::InitScene()
{
	...
	//ジャンプする敵
	Draw::LoadImage(L"Animation/slime.png", 12, TEX_SIZE_512);

	//ボス
	Draw::LoadImage(L"Animation/motion1.png", 13, TEX_SIZE_2048); 

	//弾丸を飛ばす敵
	Draw::LoadImage(L"Animation/motion3.png", 14, TEX_SIZE_2048); 
